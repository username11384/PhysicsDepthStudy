All code reproducable with python, matplotlib, numpy and pandas. To install, get the python interpreter and then just run `pip install matplotlib` , `pip install numpy` and `pip install pandas`
